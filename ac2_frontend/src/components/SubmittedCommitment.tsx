              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-slate-200 rounded-lg text-black focus:border-blue-500 focus:outline-none transition-colors"
                    required
                  />
                </div>
                ...
                <div className="mb-6">
                  <label htmlFor="commitNumber" className="block text-sm font-semibold text-slate-700 mb-2">
                    Required number of commitments for your reveal <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    inputMode="numeric"
                    ...
                    className={`w-full px-4 py-3 border-2 rounded-lg text-black focus:outline-none transition-colors ${
                  ...
                  />
                  {commitNumber.length > 0 && !isCommitNumberValid && (
                    <p className="text-sm text-red-600 mt-2">Please enter a number of people</p>
                  )}
                </div>
